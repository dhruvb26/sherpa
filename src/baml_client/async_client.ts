...
import {Node, NodeData, Paper, Position, Resume, Style} from "./types"
...
class BamlStreamClient {
  ...
  ExtractPaper(
      prompt: string,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<Paper>, Paper> {
    try {
      ...
      return new BamlStream<RecursivePartialNull<Paper>, Paper>(
        raw,
        (a): a is RecursivePartialNull<Paper> => a,
        (a): a is Paper => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
